    ...
    <main className="min-h-screen bg-[#f5f5f3] text-neutral-950">
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-6 max-w-2xl text-sm leading-7 text-neutral-600">
          The page you requested is not currently available. Explore Houston housing
          guidance or request tailored support based on your criteria.
        </p>

        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/houston/cypress"
